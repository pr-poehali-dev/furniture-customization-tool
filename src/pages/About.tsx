      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <p className="font-golos text-base text-[#e8d5b0]/65 max-w-xl leading-relaxed">
            ARTES — мебельная мастерская премиум-класса. С 2010 года мы реализуем частные и коммерческие интерьеры по всей России, сохраняя ремесленный подход к каждому заказу.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 font-golos text-sm text-[#e8d5b0]/55 leading-relaxed">
                ...
                <p>
                  Репутация росла быстро: клиенты рекомендовали нас друзьям. Сегодня ARTES — это команда из 60+ мастеров, современный производственный цех площадью 2500 м² и более 2400 реализованных проектов.
                </p>
                <p>
